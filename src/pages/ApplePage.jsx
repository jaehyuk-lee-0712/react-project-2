...
const ApplePage = () => {
  // const {data , loading} = useFetchData('https://raw.githubusercontent.com/kimyih/music-best/main/apple/apple100_2024-06-04.json');

  // https://raw.githubusercontent.com/webs9919/music-best/main/apple/apple100_2024-06-04.json
  ...
  return (
    <>
      {loading ? (
        ...
        <Chart title="Apple 차트 TOP 100" musicList={data}
